...
public static class MeshGenerator
{
    ...
    public static MeshData GenerateMeshData(float[,] heightMap, MeshSettings meshSettings, int levelOfDetail)
    {
        ...
        int[,] vertexIndiceMap = new int[numVertsPerLine, numVertsPerLine];
        ...
        for (int y = 0; y < numVertsPerLine; y ++)
        {
            for (int x = 0; x < numVertsPerLine; x ++)
            {
                ...
                {
                    vertexIndiceMap[x, y] = outOfMeshVertexIndex;
        ...
        for (int y = 0; y < numVertsPerLine; y++)
        {
            for (int x = 0; x < numVertsPerLine; x++)
            {
                ...
                if (!isSkippedVertex)
                {
                    ...
                    //creates the uv values of the new vertices
                    ...
                    //prevents the script from generating vertices from the far right column and bottom row
                    ...
                    if (createTriangle)
                    {
                        ...
                        int b = vertexIndiceMap[x + currentIncrement, y];
                        int c = vertexIndiceMap[x, y + currentIncrement];
                        int d = vertexIndiceMap[x + currentIncrement, y + currentIncrement];

                        //stores the positions of two triangles making up a quad
...
public class MeshData
{
    ...
    public MeshData(int numVertsPerLine, int skipIncrement, bool useFlatShading)
    {
        ...
        int numMainTriangles = (numMainVerticesPerLine - 1) * (numVertsPerLine - 1) * 2;
